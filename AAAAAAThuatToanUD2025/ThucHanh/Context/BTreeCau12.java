 ...
 */
public class BTreeCau12<Key extends Comparable<Key>, Value>  {
    ...
    public static void main(String[] args) {
         BTreeCau12<String, Double> st = new BTreeCau12<>();

        // danh sách sinh viên (tên, điểm)
        String[] names = {
            "An", "Anh", "Ánh", "Bá", "Bình", "Bích",
            "Lan", "Loan", "Lanh", "Quang", "Quangv",
            "Quỳnh", "Quoan", "Thái", "Thanh", "Thu", "Thoong"
        };

        double[] scores = {
            7.5, 8.0, 6.8, 7.2, 8.5, 7.9,
            6.5, 8.3, 7.0, 8.1, 6.9,
            8.4, 7.3, 9.0, 8.2, 7.7, 6.7
        };

        // nạp vào B-tree
        for (int i = 0; i < names.length; i++) {
            st.put(names[i], scores[i]);
        }

        // tra cứu thử
        System.out.println("Điểm của An: " + st.get("An"));
        System.out.println("Điểm của Lan: " + st.get("Lan"));
        System.out.println("Điểm của Quỳnh: " + st.get("Quỳnh"));

        System.out.println("\nSố SV: " + st.size());
        System.out.println("Chiều cao cây: " + st.height());
        System.out.println(st); // in cấu trúc B-tree
    }
