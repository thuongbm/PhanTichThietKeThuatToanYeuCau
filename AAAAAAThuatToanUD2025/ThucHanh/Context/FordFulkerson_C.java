...
public class FordFulkerson_C {
     ...
     */
    public FordFulkerson_C(FlowNetwork G, int s, int t) {
        V = G.V();
        validate(s);
        validate(t);
    ...
    private Queue<FlowEdge> minCut(FlowNetwork G, int s)  {    
        Queue<FlowEdge> testcut = new Queue<FlowEdge>();
        for (int v = 0; v < G.V(); v++) {
            for (FlowEdge e : G.adj(v)) {
    ...
    public static void main(String[] args) {
        ...
        FordFulkerson_C maxflow = new FordFulkerson_C(G, s, t);
