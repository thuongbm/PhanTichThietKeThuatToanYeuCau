...
public LexicalAutomata(String fileName, Automata automata)  {
...
public void printType(Map<String, ArrayList<Integer>> mp) {
    Iterator<Map.Entry<String, ArrayList<Integer>>> it = mp.entrySet().iterator();
    ...
    System.out.print( "Doan nhan" + " " + automata.recognizes(id) + "  ");
    automata.print();
}
}
...
public static void main(String[] args) throws IOException {
    ...
    new LexicalAutomata("FrequencyCounter.txt", new Automata());
}
